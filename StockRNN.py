...
#Get the stock quote
df = web.DataReader('AAPL', data_source='yahoo', start='2000-01-01', end='2020-10-03')
#show data
df
...
#Get the quote
apple_quote = web.DataReader('AAPL', data_source = 'yahoo', start='2000-01-01', end='2020-10-03')
#Create a new dataframe
new_df = apple_quote.filter(['Close'])
#Get the last 60 day closing price values and convert the dataframe to an array
last_60_days = new_df[-60:].values
#Scale the data to be values to be values betweem 0 and 1
last_60_days_scaled = scaler.transform(last_60_days)
#Create an empty list
X_test = []
#Append the past 60 days
X_test.append(last_60_days_scaled)
#Convert tge X_test data set to a numpy array
X_test = np.array(X_test)
#Reshape the data
X_test = np.reshape(X_test, (X_test.shape[0], X_test.shape[1], 1))
...
apple_quote = web.DataReader('AAPL', data_source = 'yahoo', start='2020-10-03', end='2020-10-03')
